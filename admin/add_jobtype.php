...
if(isset($_POST["submit"]))
    {
        ...
        $qury="INSERT INTO jobtype(jobtype) VALUES('$jobtype')";
        $obj=mysqli_query($conn,$qury) or die("erorr");
      if($obj)
		{ 
			?><script>
      window.location.href="add_jobtype.php";</script>';
      <?php
		}
		else
			mysqli_error($conn);
...
.wrapper{
  ...
  <div id="wrapper">
     ...
     <nav class="navbar navbar-default  navbar-light white bootsnav">ootsnav">
        <div class="container">     
      ...
      <form method="post" action="#">
        <center><h2 class="detail-title1">ADD JOBTYPE</h2>
        <br>
        <br>
      ...
      <div class="col-md-offset-4 col-md-4 col-sm-10 text-center">
              ...
              <input type="text" class="form-control" placeholder="jobtype" id="jobtype" name="jobtype">
              </div>  
              </div>
