...
tr:hover {background-color:#f5f5f5;}
  ...
  <body>
     ...
     <!-- Sidebar -->
        <div id="sidebar-wrapper">
            <ul class="sidebar-nav">
              ...
              <li>
                ...
                <li>
                    <a href="manage_company.php">MANAGE USER</a>
                </li>
                <li>
      ...
      <center>
      <h2 class="detail-title1">MANAGE COMPANY</h2>
      
      <br id="id"><a href="jobinfo.php">More Info..</a>
      <table>  
      <tr>
        <th>COMPANY NAME</th>
        ...
        <th></th>
            ...
            <!-- block company-->
      <?php
      $qury="select * from company_registration ";
      ...
      while($row=mysqli_fetch_array($result))
    {
      ...
      <tr>
        ...
        <td>
          <a href="company_block.php?id='<?php echo $row[0];?>'">
