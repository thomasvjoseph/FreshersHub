     ...
     <!-- Sidebar -->
        <div id="sidebar-wrapper">
            <ul class="sidebar-nav">
               ...
               <li>
                ...
                <li>
                    <a href="company/change_passwoed.php">CHANGE PASSWORD</a>
                </li>
                <li>
      ...
      <div class="banner" style="background-image:url(../assets/img/banner-9.jpg);">  
       ...
       <form id="form1" name="form1" method="post" action="#" >
        <center><h2 class="detail-title1">MANAGE JOBS</h2>
        <br>
        <br>
...
<table>  
      <tr>
        ...
        <th></th>
            ...
            <!-- block company-->
      <?php
      $qury="select * from create_job where cid='$cid'";
      ...
      while($row=mysqli_fetch_array($result))
    {
      ...
      <tr>
        ...
        <td><?php echo$row[7]?>s</td>
        <td><a href="block_job.php?id='<?php echo $row[0];?>'"><input type="submit" name="submit" value="block"></a></td>
      </tr>
...
<center>  
    <div  style = "height:30px; width:990px; box-sizing:border-box;font-color:white;font-size: 20px;background-color: white;margin-bottom: 100px;margin-top: 540px;">
           <div  style = "height:30px; width:1000px; box-sizing:border-box;font-color:white;margin-bottom: 100px">
