...
$confirmpas=md5($_POST['confirmpass']);

$qury1="SELECT * from login where logid='$uid'";
...
if($password==$currentpass)
{
  ...
  {
    $sql="UPDATE login set password='$newpass'  where logid='$uid'"; 
     ...
     <!-- Sidebar -->
      ...
      <div class="banner" style="background-image:url(../assets/img/banner-9.jpg);">  
       ...
       <form id="form1" name="form1" method="post" action="#" >
        <center><h2 class="detail-title1">CHANGE PASSWORD</h2>
